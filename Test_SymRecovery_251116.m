...
v_fSigWdB= 20:2:20;  %Noise variance in dB
...
m_fChannelGTD = reshape(H_f_GTD(1,:,1), 4, 2)';
m_fChannelEKF = reshape(H_f_EKF(1,:,1), 4, 2)';
m_fChannelKNet = reshape(H_f_KNet(1,:,1), 4, 2)';
